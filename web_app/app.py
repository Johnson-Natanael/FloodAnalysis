    ...
    if request.method == 'POST':
        ...
        try:
            ...
            return render_template(
                ...
                url_sar_sebelum=hasil_banjir["url_sar_sebelum"],
                url_sar_sesudah=hasil_banjir["url_sar_sesudah"],
                url_sar_masked=hasil_banjir["url_sar_masked"],
                url_rgb_sebelum=hasil_banjir["url_rgb_sebelum"],
                url_rgb_sesudah=hasil_banjir["url_rgb_sesudah"],
                url_rgb_masked=hasil_banjir["url_rgb_masked"],
                url_peta_konteks=hasil_banjir["url_peta_konteks"],
